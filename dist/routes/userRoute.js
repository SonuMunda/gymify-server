 ...
 *         description: Unauthorized, user not logged in
 */
router.put("/update", trimRequest.all, isActiveUser, validate(schemas.updateProfileSchema), controller.updateUser);
/**
 * @swagger
 ...
 */
router.post("/check-username", trimRequest.all, isActiveUser, validate(schemas.checkUsernameSchema), controller.checkUsername);
/**
 * @swagger
 ...
 *         description: Unauthorized, user not logged in
 */
router.put("/update-avatar", trimRequest.all, isActiveUser, validate(schemas.updateAvatarSchema), controller.updateAvatar);
